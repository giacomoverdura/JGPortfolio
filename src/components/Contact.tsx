...
export default function Contact() {
  return (
    <section id="contact" className="mb-10 border-b border-gray-300 pb-10">
      ...
      <div className="grid grid-cols-6 grid-rows-2 gap-4 text-gray-500">
          <div className="col-span-3 row-span-2 text-sm">
            <div className="border border-gray-500/20 hover:bg-gray-300/20 p-1 rounded-lg w-80 flex items-center justify-center mt-2">
              <input type="text" placeholder="Name" className="focus:outline-none m-1 w-75" />
            </div>

            <div className="border border-gray-500/20 hover:bg-gray-300/20 p-1 rounded-lg w-80 flex items-center justify-center mt-2">
              <input type="email" placeholder="Email Address" className="focus:outline-none m-1 w-75" />
            </div>

            <div className="border border-gray-500/20 hover:bg-gray-300/20 p-1 rounded-lg w-80 flex items-center justify-center mt-2">
              <textarea rows={5} placeholder="Your message" className="focus:outline-none m-1 w-75" />
            </div>

            <button type="submit" className="bg-green-800/80 hover:bg-green-800 transition-color duration-300 mt-2 p-2 cursor-pointer rounded-lg text-white">
              Send Message
            </button>
          </div>
            ...
            <div className="flex justify-between gap-2">
              ...
              <div className="other-grid">
                ...
                <div className="flex flex-col w-auto">
                  ...
                  <a href="#" className="mb-2 text-gray-600 hover:text-gray-500"> Read my Blog</a>
                  <a href="#" className="mb-2 text-blue-600 hover:text-blue-500">Buy me a Coffee</a>
                </div>
              </div>              
            </div>
